...
public class PlayerController : MonoBehaviour
{
    ...
    public GameObject DH4;
    public GameObject DH5;
    public GameObject DH6;
    ...
    void Start()
    {
        ...
        switch (cs.currentdonutIndex) 
        {
            ...
            case 2:
                ...
                case 3:
                {
                    animator = DH4.GetComponent<Animator>();
                    break;
                }
                case 4:
                {
                    animator = DH5.GetComponent<Animator>();
                    break;
                }
                case 5:
                {
                    animator = DH6.GetComponent<Animator>();
                    break;
                }
            default:
                {
